...
def save_audio_to_file(audio_bytes, file_path):
    if not os.path.exists(file_path.split("/")[0]):
        os.makedirs(os.path.join(*file_path.split("/")[:-1])) # 创建目录
...
def handle(refer_wav_path, prompt_text, prompt_language, text, text_language, cut_punc, gpt_path, sovits_path):
    if (
    ...
    return StreamingResponse(get_tts_wav(refer_wav_path, prompt_text, prompt_language, text, text_language, gpt_path, sovits_path), media_type="audio/"+media_type)
...
# 默认参考音频及文本
default_refer_path = "training_data/megumi/sliced/megumi.mp4_0006951680_0007070080.wav"
default_refer_text = "主人公相手だって考えればいいのか"
# default_refer_path = "/Users/danieljames/Downloads/utaha_ref.mp3"
# default_refer_text = " "

parser.add_argument("-s", "--sovits_path", type=str, default=g_config.sovits_path, help="SoVITS模型路径")
parser.add_argument("-g", "--gpt_path", type=str, default=g_config.gpt_path, help="GPT模型路径")
parser.add_argument("-dr", "--default_refer_path", type=str, default=default_refer_path, help="默认参考音频路径")
parser.add_argument("-dt", "--default_refer_text", type=str, default=default_refer_text, help="默认参考音频文本")
parser.add_argument("-dl", "--default_refer_language", type=str, default="日文", help="默认参考音频语种")
